...
class Eggs(Spam):                       # Ancestor superclasses inside
                                        #     parentheses for inheritance
                                        #
    a_class_attr = "class_val"          # Class attributes inside the body,
                                        #     outside class methods.
                                        #     Must have a value!
                                        #
    def __init__(self, attr_val):       # __init__ is called in the instances
                                        #     initialization (not constructor)
        self.attr = attr_val            #
    def method(self, arg1, arg2=None):  # Method declaration. Indented and
                                        #     receiving self (the instance)
                                        #
        print "'method' of", self       #
        print self.attr, arg1, arg2     # Access instance attributes using
                                        #     *self* with a dot .
    def second_method(self):            #
        self.attr = 99.99               #
        self.method("FROM 2nd")         # Methods may call other methods
                                        #     using self.<method-name>
...
class Spam:
    def spam_method(self):
        print self.__class__  # __class__ is a special attribute
        print type(self)      #     containing the class of any object.
...
class Spam(object):
    spam_class_attr = "spam"         # Class attributes must always
                                     #     have a value (you may use None...)
...
class Fooo(Spam, Eggs):         # Specify a list of ancestor superclasses
    ...
    def fooo_method(self):
        self.spam_method()      # Retrieve superclasses attributes
        self.eggs_method()      #     as if they were yours
...
print foooer.fooo_class_attr  # We have access to all own and
...
#============================================================================
# REMEMBER:
#     - Classes are declared with the 'class' keyword, its name in
#       camel case and a colon
#         - Specify ancestors superclasses list between parentheses after
#            the class name
...
#     - Specify class attributes (with value) inside the class,
#       outside any method
#     - Specify methods inside the body, with indentation (method body
#       has 2x indentation)
#         - Method's first parameter is always self, the instance whose
...
#============================================================================
#     - When inheriting, ancestors attributes and methods can be
#       accessed transparently
#     - There are no private attributes in Python
#         - There is a convention to use underscore _ prefix
#     - Classes definition is not closed. At any time you can add
#       (or delete) an attribute
#     - classmethod to specify class methods; bounded to the class, not
#       its instances
#        - Used to implement alternative constructors (e.g. dict.copy)
#     - staticmethod to specify static methods; standard functions declared
#       inside the class
#        - Only for organisation, it is equivalent to declare the function
#          in the class module
#============================================================================
